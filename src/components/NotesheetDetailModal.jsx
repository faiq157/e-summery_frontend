...
const NotesheetDetailModal = ({
  ...
  const generatePDF = (notesheet, rolesData) => {
    ...
    doc.text(
      `Created At: ${new Date(
        notesheet?.timestamps?.createdAt
      ).toLocaleString()}`,
      20,
      yOffset
    );
        ...
        <div className=" flex  ">
          <div className="w-1/2 mb-4 space-y-2 bg-blue-50 p-4 m-4  rounded-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-800 font-medium">
                    {new Date(notesheet?.timestamps.createdAt).toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
            <div className="flex justify-between items-center ">
              ...
              <Button
                className="rounded-full"
                onClick={() => generatePDF(notesheet, rolesData)}
              >
                <Download className="" />
              </Button>
            </div>
        ...
        <div className=" mb-4 p-4 bg-gray-50 rounded-lg">
          {status !== "In Progress" && status !== "Completed" && (
            <>
              <div
                className={`grid ${
                  hasAccess ? "grid-cols-2" : "grid-cols-1"
                } gap-2`}
              >
              ...
              <div className="mt-4 flex justify-between">
                <div className="flex justify-between w-full">
                  ...
                  <div className="flex gap-4">
                    <Button className="rounded-full" onClick={handleSendClick}>
                      Send
                    </Button>
                      ...
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          ...
                          <div className="flex justify-end space-x-2">
                            <AlertDialogCancel onClick={handleCompleteClose}>
                              Cancel
                            </AlertDialogCancel>
